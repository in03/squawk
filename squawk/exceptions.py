...
class ResolveInvalidRenderPresetError(Exception):
    def __init__(self, render_preset, message: str = ""):
        ...
        if message != "":
            ...
            self.message = (
                f"The chosen Resolve render preset: '{render_preset}' does not exist."
            )
